...
'''
将labelme生成的json文件转换成yolo格式的归一化（自己查查归一化是怎么搞的）txt文件
先打框还是先打点，点的顺序如何都没关系 只要标签对应信息正确，顺序无所谓

具备错误查找能力，必须是label group_id 都正确才行
...
修改：json_directory output_directory

'''

json_directory = 'C:/Users/YY/Desktop/all/res'  # 替换成您的 JSON 文件所在的文件夹路径
output_directory = 'C:/Users/YY/Desktop/all/res'  # 替换成您希望保存 TXT 文件的文件夹路径
